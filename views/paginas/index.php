...
<section class="spakers">
    <h2 class="spakers__heading">Speakers</h2>
    <p class="spakers__descripcion">Conoce a nuestros expertos de DevWebCamp</p>
    ...
    <div class="speakers__grid">
        <?php foreach ($ponentes as $ponente){?>
            ...
            <picture>
                    ...
                    width="200" height="300" loading="lazy" src="img/speakers/<?php echo $ponente->imagen; ?>.png" alt="Imagen Ponente">
                </picture>
